...
WHATSAPP_WEBHOOK_LOG_PATH = os.environ.get(
    ...
    str(Path(app.root_path) / 'logs' / 'whatsapp_webhook.log')
)
...
def get_whatsapp_webhook_logger():
    global WHATSAPP_WEBHOOK_LOGGER
    ...
    if not logger.handlers:
        log_path = Path(WHATSAPP_WEBHOOK_LOG_PATH)
...
def webhook_debug():
    ...
    return jsonify({
        ...
        'webhook_log_path': WHATSAPP_WEBHOOK_LOG_PATH,
    })
